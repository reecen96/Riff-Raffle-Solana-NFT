...
${SCRIPT_PATH}/../target/debug/draffle add-prize BQ2CVceaCP5HSNGeByWit2a5KCKRMGzRPuX2KRKbS9HE ${MINT2_ADDRESS} 25 0
...
${SCRIPT_PATH}/../target/debug/draffle add-prize 4XQndUu4ReZiAg8vtRDFuYmPFGs1wq193YVXYbEtFa16 ${MINT2_ADDRESS} 25 0
${SCRIPT_PATH}/../target/debug/draffle add-prize 4XQndUu4ReZiAg8vtRDFuYmPFGs1wq193YVXYbEtFa16 ${NFT2_ADDRESS} 1 1
${SCRIPT_PATH}/../target/debug/draffle add-prize 4XQndUu4ReZiAg8vtRDFuYmPFGs1wq193YVXYbEtFa16 ${MINT1_ADDRESS} 30100000 2
